...
__kernel 
void KeccakSingleWorkItemMultipleHash(__global uint64_t *data, __global uint64_t *out){
        
        int x = get_global_id(0);
        __local uint64_t A[25], B[25], C[5], D[5];
        
        for(int a = 0, b = x*25; b < (x*25)+25 , a<25;b++, a++){
            A[a] =  data[b];
        ...
        for(int i=0, b=x*25; i < 25, b<x*25+25; i++,b++)    
           out[b] = A[i];
